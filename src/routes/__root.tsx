        ...
        <div className="flex gap-8 pointer-events-auto text-xl mt-2">
          ...
          >
            <img
              ...
              className="w-[50px] h-[50px] transition-transform duration-500 ease-in-out hover:scale-110"
            />
            <span className="absolute left-1/2 -translate-x-1/2 top-[60px] text-blue-700 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 group-[&.active]:opacity-100">
              Home
            </span>
          </Link>
          <Link
          ...
          >
            <img
              ...
              className="w-[50px] h-[50px] transition-transform duration-500 ease-in-out hover:scale-110 rounded-full"
            />
            <span className="absolute left-1/2 -translate-x-1/2 top-[60px] text-blue-700 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 group-[&.active]:opacity-100">
              Play
            </span>
